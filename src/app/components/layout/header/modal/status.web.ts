// import './status.web.scss';
import {IShopServices, IProductOption, IProduct, IFormContainer} from "../../../../services/shopServices/shop.services";
 ...
 */
class StatusWebController implements IFormContainer {
    /**
     * @ngdoc       property
...
export const statusWeb = {
    templateUrl: 'app/layout/header/modal/status.web.html',
    controller: StatusWebController,
    bindings: {
        resolve: '<',
        close: '&'
    }
